package com.light.myilists.widget;
...
/**
 * Created by light on 15/6/22.
 */
public class SwipeAddLayout extends ViewGroup{
     ...
     * @param context
     */
    public SwipeAddLayout(Context context) {
        this(context, null);
    }
     ...
     * @param attrs
     */
    public SwipeAddLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        mSpinnerFinalOffset = DEFAULT_CIRCLE_TARGET * metrics.density + 48;
    ...
    private void createProgressView() {
        ...
        //mCircleView.setImageDrawable(mProgress);
        mCircleView.setImageResource(R.drawable.add);
        mCircleView.setVisibility(View.GONE);
        addView(mCircleView);
    }
